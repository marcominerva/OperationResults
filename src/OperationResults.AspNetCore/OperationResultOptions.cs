...
/// <summary>
/// Configures how <see cref="Result"/> and <see cref="Result{T}"/> values are translated into ASP.NET Core <see cref="Microsoft.AspNetCore.Mvc.IActionResult"/> responses.
/// </summary>
/// <remarks>
/// Register and customize this type through AddOperationResult so controllers can map business-layer result codes to HTTP responses consistently.
/// </remarks>
public class OperationResultOptions
{
    ...
    /// </summary>
    /// <remarks>
    /// Applications can add or replace entries to keep domain and application services focused on <see cref="FailureReasons"/> or custom failure codes while controllers return protocol-appropriate status codes.
    /// </remarks>
    ...
    /// <summary>
    /// Gets or sets the HTTP status code returned for unmapped failure reasons when <see cref="UnmappedFailureReasonBehavior"/> is <see cref="AspNetCore.UnmappedFailureReasonBehavior.UseDefaultStatusCode"/>.
    /// </summary>
