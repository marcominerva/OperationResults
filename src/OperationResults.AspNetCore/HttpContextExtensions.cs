...
/// <summary>
/// Provides <see cref="HttpContext"/> extension methods that turn operation results into ASP.NET Core controller responses.
/// </summary>
/// <remarks>
/// These helpers keep controller actions concise while preserving the separation between business services that return <see cref="Result"/> values and presentation code that returns <see cref="IActionResult"/>.
/// </remarks>
public static class HttpContextExtensions
{
    /// <summary>
    /// Creates an ASP.NET Core response for a non-generic operation result.
    /// </summary>
    ...
    /// <summary>
    /// Creates an ASP.NET Core route-based response for a successful non-generic operation result, or a problem response when it fails.
    /// </summary>
    /// <param name="httpContext">The current HTTP context used to resolve response-mapping services and request metadata.</param>
    /// <param name="result">The operation result to translate.</param>
    ...
    /// <summary>
    /// Creates an ASP.NET Core response for a typed operation result.
    /// </summary>
    ...
    /// <summary>
    /// Creates an ASP.NET Core route-based response for a successful typed operation result, or a problem response when it fails.
    /// </summary>
    /// <typeparam name="T">The type of content carried by the operation result.</typeparam>
    /// <param name="httpContext">The current HTTP context used to resolve response-mapping services and request metadata.</param>
    /// <param name="result">The operation result to translate.</param>
