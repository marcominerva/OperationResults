...
/// <summary>
/// Defines how ASP.NET Core response mapping handles a <see cref="Result.FailureReason"/> value that is not present in <see cref="OperationResultOptions.StatusCodesMapping"/>.
/// </summary>
/// <remarks>
